...
#if MY_SORTING_INCLUDED == 1
    char randomGermanNames[][20] = {"MARLON", "OLAF", "MANFRED", "URS", "THEOPHILUS", "TORSTEN", "UDO", "MORITZ",
                                    "VIET", "RAINER", "OLIVER", "OSCAR", "WILBUR", "OLE", "YANNICK", "ZOLTHAR", "OSKAR",
                                    "UWE", "XAVER", "WIM", "MALTE", "RUDI", "OLLI", "WILMAR", "PASCAL", "OTTO",
                                    "MARTIN", "NOAH", "ULLI", "MIKA", "SVEN", "TORBEN", "WILFRIED", "MATHIS",
                                    "WILIBALD", "ROLF", "WILHELM", "MARVIN", "WALTER", "WOLF", "WILLY", "NIELS", "MADS",
                                    "MATTHIAS", "TEO", "VOLKER", "ROTGIER"};
    constexpr char sortedGermanNames[][20] = {"MADS", "MALTE", "MANFRED", "MARLON", "MARTIN", "MARVIN", "MATHIS",
                                              "MATTHIAS", "MIKA", "MORITZ", "NIELS", "NOAH", "OLAF", "OLE", "OLIVER",
                                              "OLLI", "OSCAR", "OSKAR", "OTTO", "PASCAL", "RAINER", "ROLF", "ROTGIER",
                                              "RUDI", "SVEN", "TEO", "THEOPHILUS", "TORBEN", "TORSTEN", "UDO", "ULLI",
                                              "URS", "UWE", "VIET", "VOLKER", "WALTER", "WILBUR", "WILFRIED", "WILHELM",
                                              "WILIBALD", "WILLY", "WILMAR", "WIM", "WOLF", "XAVER", "YANNICK",
                                              "ZOLTHAR"};
...
TEST_F(MySortTester, sortingConstCharPtrIgnoreCases_expectedAllWordsSortedDespiteDifferentCases) {
    ...
    char words[][20] = {"Bazyli", "lubi", "Malfreda", "ktorego", "poznal", "u", "Stoigniewa", "stojacego", "przy",
                        "barze", "mamy"};
    constexpr char sortedWords[][20] = {"barze", "Bazyli", "ktorego", "lubi", "Malfreda", "mamy", "poznal", "przy",
                                        "Stoigniewa", "stojacego", "u"};
